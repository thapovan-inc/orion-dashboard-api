        ...
        var requestStatistics = [
            {
                ...
                deviceInfo: {model: 'GT-P5100', phoneType: 'tablet', brand: 'samsung', screenSize: '1280 X 752', androidversion: '4.0.3'},
                location: 'Chennai',
                status: 'FAIL',
                lifeCycle : [
                    {
                        ...
                        parentSpanId: '',
                        metadata: {
                            request: {username: 'johndeo', firstName: 'john', lastName: 'deo', email: 'john@gmail.com', mobile: 9876543211},
                            response: {samplerType: 'const', samplerParam: true, spanKind: 'server', httpMethod: 'GET', httpUrl: '/api/services', component: 'net/http', httpStatusCode: 503}
                        },
                        status: 'FAIL',
                        child: [
                            {
                                ...
                                metadata: {
                                    request: {username: 'johndeo', firstName: 'john', lastName: 'deo', email: 'john@gmail.com', mobile: 9876543211},
                                    response: {samplerType: 'const', samplerParam: true, spanKind: 'server', httpMethod: 'GET', httpUrl: '/api/services', component: 'net/http', httpStatusCode: 200}
                                }
                            },
                            {
